...
const find = memoizeWith(x => x, x => hydratedData.find(y => y.input === x))
...
console.log('Starting time', timer)
grow(initPattern, 15)

// 15 iterations takes 22 seconds before optimization

console.log('Completion in ', ((new Date().getTime() - timer.getTime()) / 1000) + ' seconds')
